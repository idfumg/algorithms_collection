...
int main() { TimeMeasure _; __x();
    cout << "Recursive: " << rec(2) << endl;
    cout << "Recursive: " << rec(3) << endl;
    cout << "Tabulation: " << tab(2) << endl;
    cout << "Tabulation: " << tab(3) << endl;
    cout << "Optimization: " << opt(2) << endl;
    cout << "Optimization: " << opt(3) << endl;
    cout << "Optimization2: " << opt2(2) << endl;
    cout << "Optimization2: " << opt2(3) << endl;
}
