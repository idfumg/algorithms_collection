...
int rec_(int m, int n) {
    if (m < 0 or n < 0) return 0;
    if (m == 0 and n == 0) return 1;
    return rec_(m - 1, n) + rec_(m, n - 1);
}
...
int main() { TimeMeasure _; __x();
    cout << "Recursive: " << rec(2, 2) << endl;
    cout << "Recursive: " << rec(2, 3) << endl;
    cout << "Recursive: " << rec(3, 3) << endl;
    cout << "Tabulation: " << tab(2, 2) << endl;
    cout << "Tabulation: " << tab(2, 3) << endl;
    cout << "Tabulation: " << tab(3, 3) << endl;
    cout << "Optimization: " << opt(2, 2) << endl;
    cout << "Optimization: " << opt(2, 3) << endl;
    cout << "Optimization: " << opt(3, 3) << endl;
}
