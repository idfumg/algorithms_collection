...
// n = 10: 1 1 2 5 14 42 132 429 1430 4862

ll catalan_naive(ll n) {
    if (n <= 1) return 1;
    ll res = 0;
    for (ll i = 0; i < n; ++i) {
        res += catalan_naive(i) * catalan_naive(n - 1 - i);
    }
    return res;
}
...
int main() { TimeMeasure _;
    cout << "Catalan Naive: " << endl;
    for (int i = 0; i < 10; ++i) cout << catalan_naive(i) << ' ';
    cout << endl << endl;

    cout << "Catalan DP: " << endl;
