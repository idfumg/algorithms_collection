...
[[maybe_unused]] static const auto x = [](){ios_base::sync_with_stdio(0); cin.tie(0); cout.tie(0); cout.precision(15); cout.setf(ios::boolalpha);};
...
int main() { TimeMeasure _; x();
    cout << "Recursive: " << rec(3) << endl;
    cout << "Recursive: " << rec(4) << endl;
    cout << "Tabulation: " << tab(3) << endl;
    cout << "Tabulation: " << tab(4) << endl;
    cout << "Optimized: " << optimized(3) << endl;
    cout << "Optimized: " << optimized(4) << endl;
    cout << "Optimized2: " << optimized2(3) << endl;
    cout << "Optimized2: " << optimized2(4) << endl;
}
